...
var MonthYearColor = "#1C5543"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#374C66"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#D6D6D6"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#D6D6D6"; //Background color of Saturday.
var WeekDayColor = "#D6D6D6"; //Background color of weekdays.
var FontColor = "maroon"; //color of font in Calendar day cell.
var TodayColor = "#742734"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#26568E"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#000000"; //color when mouse move over.
var DisableColor = "#999966"; //color of disabled cell.
var CalBgColor = "#8C98A7"; //Background color of Calendar window.
